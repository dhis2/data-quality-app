...
describe('Test <ValidationRulesDetails /> rendering:', () => {
    ...
    it('Should render a FontIcon to open details.', () => {
        ...
        const fontIconWrapper = mount(
            <MuiThemeProvider>{detailsIcon}</MuiThemeProvider>
        )
        expect(
            fontIconWrapper
                .find(FontIcon)
    ...
    it('Firt section should show rule "Summary".', () => {
        ...
        expect(
            wrapper
                ...
                .at(3)
                .text()
        ).toBe('Measles, Slept under LLITN last' + ' night, <1 year Fixed')
        expect(
            wrapper
                .find('.row')
                .at(0)
                ...
                .at(5)
                .text()
        ).toBe('Question asked at Measles')
    })
    ...
    it('Second section should show "Left Side" information.', () => {
        ...
        expect(
            ...
            'Q_Slept under LLIN last night Measles' +
    ...
    it('Third section should show "Right Side" information.', () => {
        ...
        expect(
            wrapper
                ...
                .at(3)
                .text()
        ).toBe('Measles doses given Fixed,' + ' <1y<FormattedNumber />')
        expect(
            wrapper
                .find('.row')
                .at(3)
